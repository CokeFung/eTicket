...
<div id="main">
    ...
    <nav class="navbar navbar-light bg-dark fixed-top">
      <!--LOGO-->
      <a class="navbar-brand"><h3 style="color: white;">eTicket</h3></a>
      <!---->
      <!--update page-->
      <h3>
        <div id="navbar-status" style="color: white;">
      ...
      <!--END update page-->
       <div id="mySidenav" class="sidenav fixed-top">
        ...
        <div class="dropdown">
            <a href="#" class="dropdown-toggle btn btn-outline-light" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                {{ Auth::user()->name }} <span class="caret"></span>
            </a>
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-menu btn btn-light block">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#take-ticket">Get ticket</button>
...
<!-- Get Ticket-->
<div class="modal" tabindex="99" role="dialog" id="take-ticket">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id='ticket-head'>Take it!</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <center><img src="image/ticket/QRcode.jpg" height="350px"></center>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
